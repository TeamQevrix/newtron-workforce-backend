...
import com.newtron.newtron_workforce_backend.dto.RecruiterProfileRequest;
...
public class RecruiterProfileController {
    ...
    @PutMapping("/basic")
    @Transactional
    public ApiResponse<Void> updateBasicProfile(
        ...
        if (currentUser.getRole() != Role.RECRUITER) {
            throw new ValidationException("UNAUTHORIZED_ACCESS", "Access denied. Only recruiters can update recruiter profile.");
        }
        ...
        return ApiResponseFactory.success(null, "Profile updated successfully",
